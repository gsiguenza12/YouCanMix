...
public class Alcohol extends beverageDecorator {
    private String type;
    public Alcohol(Beverage beverage, String type) { this.beverage = beverage; this.name = beverage.getName(); this.type = type;}
